...
// 	flow = (Flow)flow.clone();
	...
	String[] actionRightArray = (String[])ArrayUtil.format(request.getParameterValues("actionRight"), new String[0]);
	for(String actionRight : actionRightArray)
	{
		UUID actionId = DataAccessFactory.getInstance().createUUID(actionRight.split("\\|")[0]);
		boolean right = Boolean.parseBoolean(actionRight.split("\\|")[1]);
