...
<body onload="initScriptList()" >
	...
	<div id="main" style="margin-top:50px;">
		...
		<div id="content">
			<div id="box">
				<table class="table table-striped table-bordered table-hover table-condensed" id="maintable" cellpadding="0" cellspacing="0">
 						<tbody>
    					<tr>
    						<th width="50px;">序号</th>
    						<th width="500px;">名称</th>
    						<th width="150px;">创建人</th>
    						<th>是否异步</th>
    						<th>提交之前</th>
    						<th>提交成功</th>
    						<th>提交失败</th>
