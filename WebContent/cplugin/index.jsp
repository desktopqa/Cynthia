...
<body>
	...
	<div id="main" style="margin-top:50px;">
		...
		<div id="content">
			<div id="box">
				<table class="table table-striped table-bordered table-hover "  id="maintable" cellpadding="0" cellspacing="0">
 					<!-- <caption>统计器列表</caption>  -->
    					<tr>
   		 				...
   		 				<tr>
    						<td>1</td>
     						<td><a href='excelimportnew.jsp' target="_blank">excel数据导入插件</a></td>
        					<td>-</td>
        					<td>-</td>
   		 				</tr>
   		 				<tr>
    						<td>2</td>
     						<td><a href='templates.jsp' target="_blank">脚本配置插件</a></td>
        					<td>-</td>
        					<td>-</td>
   		 				</tr>
