...
function showFilterDataHead(showFields)
{
	...
	html+="<thead>";
	html+="<tr>";
	html+="<th class='checkbox'><i class='i-checkbox icon-input-checkbox-unchecked'></i></th>";
...
{
	 var params = '';
	 var searchConfig = decodeAll(searchXml);
	 ...
	 params += "&searchConfig=" + encodeURIComponent(searchConfig);
	 params += "&searchType=" + $("#searchType").val();
	 params += "&searchData=" + $("#searchWord").val();
	 $.ajax({
