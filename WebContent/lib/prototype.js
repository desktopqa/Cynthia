...
XMLDocument.prototype.selectSingleNode = Element.prototype.selectSingleNode =
	function (xpath)
	{
...
function getDialogArguments()
{
	if (document.all && typeof( document.all ) == "object")
		...
		return window.opener._dialogArguments
		
}

function setReturnValue(vArguments)
{
	if (document.all && typeof( document.all ) == "object")
		window.returnValue = vArguments;
	else
		window.opener._returnValue = vArguments;
}
